...
macro_rules! custom_ir_variable {
    ($vis:vis IR<$variable:ty>) => {
        $vis type Items       = $crate::ir::Items       <$variable>;
        $vis type Item        = $crate::ir::Item        <$variable>;
        $vis type FnDefine    = $crate::ir::FnDefine    <$variable>;
        $vis type Statements  = $crate::ir::Statements  <$variable>;
        $vis type Statement   = $crate::ir::Statement   <$variable>;
        $vis type Compute     = $crate::ir::Compute     <$variable>;
        $vis type VarDefine   = $crate::ir::VarDefine   <$variable>;
        $vis type VarStore    = $crate::ir::VarStore    <$variable>;
        $vis type Condition   = $crate::ir::Condition   <$variable>;
        $vis type If          = $crate::ir::If          <$variable>;
        $vis type IfBranch    = $crate::ir::IfBranch    <$variable>;
        $vis type While       = $crate::ir::While       <$variable>;
        $vis type Return      = $crate::ir::Return      <$variable>;
        $vis type OperateExpr = $crate::ir::OperateExpr <$variable>;
        $vis type Parameter   = $crate::ir::Parameter   <<$variable as $crate::ir::IRVariable>::ParameterType>;
    };
}
